import {LegalNotice} from '../interfaces/legal-notice.interface';
...
import {CreateStakeholderInput, Stakeholder} from './stakeholders/stakeholder.interface';
...
export type CreatePackageResponse = GetPackageByIdResponse;
...
export interface GetPackageByIdResponse {
     ...
     */
    DefaultLegalNotice: NullableObject<LegalNotice>;
...
export interface AddStakeholderToPackageInput {

    PackageId: string;

    Params: CreateStakeholderInput;
}
