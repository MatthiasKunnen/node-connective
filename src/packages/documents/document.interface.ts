import {CreateElementInput, CreateElementOutput} from './elements/element.interface';
...
export interface Document {
    ...
    /**
     * Name of the document. Minimum length: 1 Maximum length: 150
     */
    Name: string;

    /**
     * Date and time when the document was created according to the server. Format is ISO 8601
     * date-time. E.g. 2020-01-23T12:34:00.000Z
     */
    CreationDate: string;
    ...
    /**
     * Status of the document within the package.
     */
    Status:
        | 'draft'
        | 'pending'
    ...
    /**
     * Details of each of the elements within the document.
     */
...
export interface AddDocumentParametersInput {
     ...
     * to a signer actor.
     */
    Elements?: Array<AddDocumentElementInput>;
...
export type AddDocumentElementInput = CreateElementInput & {

    /**
     * The index of the document to add the element to. 0 for the first document, 1 for the second,
     * ...
     */
...
export type GetDocumentByIdResponse = AddDocumentResponse;
