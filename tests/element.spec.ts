...
} from '../src/packages/documents/elements/element.interface';
...
describe('deleteById', () => {
    it('should delete the document', async () => {
        ...
        const error: any = await jestGetErrorAsync(async () => {
            return connectiveClient.packages.elements.getByElementId({
                packageId,
                documentId,
                elementId: createElementResponse.data.Id,
            });
...
describe('getByElementId', () => {
    describe('signing field', () => {
        it('should be returned', async () => {
            ...
            expect(createElementResponse.data).toEqual({
...
describe('getElementsByDocumentId', () => {
    it('should return the elements', async () => {
        ...
        const getElementsResponse = await connectiveClient.packages.elements
            .getElementsByDocumentId(packageId, documentResponse.data.Id);

        expect(getElementsResponse.data).toEqual(responses.map(response => response.data));
    });
});
